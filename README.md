...
`page-loader [--output path] [--log {notset,debug,info,warning,error}] full_url_with_schema`

By default, output path is the current directory and logging runs with INFO level.
